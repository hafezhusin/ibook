...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'iBook 2.0'); ?> - <?php echo e($tetapan['nama_jabatan'] ?? 'Sistem Tempahan Bilik'); ?></title>
...
<div class="flex">
    ...
    <aside class="sidebar fixed top-0 left-0 z-30">
        ...
        <nav class="py-4">
            ...
            <a href="<?php echo e(route('kalendar')); ?>" class="sidebar-link <?php echo e(request()->routeIs('kalendar*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-calendar-days w-5"></i> Kalendar
            </a>
            <a href="<?php echo e(route('tempahan.create')); ?>" class="sidebar-link <?php echo e(request()->routeIs('tempahan.create') ? 'active' : ''); ?>">
                <i class="fa-solid fa-circle-plus w-5"></i> Tempahan Baru
            </a>
            <a href="<?php echo e(route('tempahan.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('tempahan.index') || request()->routeIs('tempahan.show') ? 'active' : ''); ?>">
                <i class="fa-solid fa-list w-5"></i> Senarai Tempahan
            </a>

            <?php if(auth()->user()->bolehLuluskan()): ?>
            <a href="<?php echo e(route('kelulusan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('kelulusan*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-circle-check w-5"></i> Kelulusan
                <?php $pending = \App\Models\Tempahan::where('status','menunggu')->count(); ?>
                <?php if($pending > 0): ?>
                <span class="ml-auto bg-red-500 text-white text-xs rounded-full px-2 py-0.5"><?php echo e($pending); ?></span>
                <?php endif; ?>
            </a>
            <?php endif; ?>

            <a href="<?php echo e(route('laporan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('laporan*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-chart-bar w-5"></i> Laporan
            </a>

            <?php if(auth()->user()->isPentadbir()): ?>
            <div class="px-8 py-2 text-xs text-slate-500 uppercase tracking-wider mt-2">Pentadbiran</div>
            <a href="<?php echo e(route('bilik.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('bilik*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-door-open w-5"></i> Bilik Mesyuarat
            </a>
            <a href="<?php echo e(route('pengguna.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('pengguna*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-users w-5"></i> Pengguna
            </a>
            <a href="<?php echo e(route('tetapan.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('tetapan*') ? 'active' : ''); ?>">
        ...
        <header class="bg-white shadow-sm sticky top-0 z-20 px-6 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <div class="relative cursor-pointer">
                    ...
                    <?php $notif = \App\Models\Tempahan::where('status','menunggu')->count(); ?>
                    <?php if($notif > 0): ?>
                    <span class="notification-badge"><?php echo e($notif); ?></span>
                    <?php endif; ?>
                </div>
                <div class="flex items-center gap-3">
                    <div class="text-right">
                        <div class="font-semibold text-sm text-gray-800"><?php echo e(auth()->user()->name); ?></div>
                        <div class="text-xs text-gray-500"><?php echo e(auth()->user()->label_peranan); ?></div>
                    </div>
...
<?php /**PATH C:\laragon\www\ibook\resources\views/layouts/app.blade.php ENDPATH**/ ?>